...
import { SubHeading, Paragraph, HeadingLight } from "../utils/styling";
  ...
  <LayoutInner>
    <Container style={{ height: "unset" }}>
      <FlexLeft>
        ...
        <Paragraph>
          As developers, we know how time consuming setting up a project can be,
          and we want to to simplify this process for you.
        </Paragraph>
        <Container style={{ height: "unset", margin: "50px 0" }}>
          <FlexLeft style={{ width: "50%" }}>
            ...
            <Paragraph style={{ maxWidth: 150 }}>
              Our templates come with cleanly written code that you can build
              off of.
            </Paragraph>
          </FlexLeft>
          <FlexRight style={{ width: "50%" }}>
            ...
            <Paragraph style={{ maxWidth: 150 }}>
              Meta tags and descriptions can be time consuming, so we do it for
              you.
            </Paragraph>
          </FlexRight>
        </Container>
        <Container style={{ height: "unset" }}>
          <FlexLeft style={{ width: "50%" }}>
            ...
            <Paragraph style={{ maxWidth: 150 }}>
              Get started with a palette of colors that you can easily apply
              across your site
            </Paragraph>
          </FlexLeft>
          <FlexRight style={{ width: "50%" }}>
            ...
            <Paragraph style={{ maxWidth: 150 }}>
              Set your font at the beginning, and we'll use google to apply it
              for you
            </Paragraph>
          </FlexRight>
        </Container>
